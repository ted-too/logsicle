...
export type UpdateEventChannelRequest = z.infer<typeof updateEventChannelSchema>;
export type UpdateAppLogChannelRequest = z.infer<typeof updateAppLogChannelSchema>;
export type UpdateRequestChannelRequest = z.infer<typeof updateRequestChannelSchema>;
export type UpdateTraceChannelRequest = z.infer<typeof updateTraceChannelSchema>;
...
export async function updateChannel(
  ...
  const res = await fetch(
    `${baseURL}/api/v1/projects/${projectId}/channels/${type}/${channelId}`,
    {
      method: "PATCH",
      headers: {
