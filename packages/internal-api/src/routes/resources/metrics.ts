...
export const METRIC_TYPES = ["GAUGE", "SUM", "HISTOGRAM", "EXPONENTIAL_HISTOGRAM", "SUMMARY"] as const;
export type MetricType = typeof METRIC_TYPES[number];

// Aggregation temporality options
export const AGGREGATION_TEMPORALITY = ["UNSPECIFIED", "DELTA", "CUMULATIVE"] as const;
