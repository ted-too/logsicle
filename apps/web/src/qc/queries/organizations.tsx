...
export const organizationsQueries = {
  ...
  list: {
    useQuery: ({ initialData }: { initialData?: UserOrganization[] } = {}) =>
      useQuery({
  ...
  getByIdQueryOptions: (organizationId: string, opts?: RequestInit) =>
    queryOptions({
  ...
  getById: {
    ...
    useSuspenseQuery: (organizationId: string) =>
      useSuspenseQuery(
        organizationsQueries.getByIdQueryOptions(organizationId)
      ),
  },
  create: () =>
    useMutation({
  ...
  update: () =>
    useMutation({
      ...
      onSuccess: (_data, { organizationId }) => {
        ...
        queryClient.invalidateQueries({
          queryKey:
            organizationsQueries.getByIdQueryOptions(organizationId).queryKey,
        });
      },
    }),
  delete: () =>
