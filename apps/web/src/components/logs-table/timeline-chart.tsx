...
import type { AppLogTimelineChart, RequestLogTimelineChart } from "@repo/api";
...
export function TimelineChart({
  ...
  const queryOptions = useMemo(
    () =>
      type === "app"
        ? getAppTimelineChartQueryOptions(currentProject.id, searchParams)
        : getRequestTimelineChartQueryOptions(currentProject.id, searchParams),
