...
export function LogsIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      />
      <rect x="8.67004" y="10" width="14.66" height="2" rx="1" fill="currentColor" />
      <rect x="8.67004" y="15" width="14.66" height="2" rx="1" fill="currentColor" />
      <rect x="8.67004" y="20" width="14.66" height="2" rx="1" fill="currentColor" />
    </svg>
  );
}
