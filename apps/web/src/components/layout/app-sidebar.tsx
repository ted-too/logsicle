...
import { Brodcast, Global, Category2, Setting2, Warning2 } from "iconsax-react";
import { ChevronsUpDown, LogOut, PlusIcon, TestTubesIcon } from "lucide-react";
...
const getMenuList = (params: {
	...
	{
		title: "App Logs",
		url: `/${params.orgSlug}/${params.projSlug}/app-logs`,
		icon: LogsIcon,
	},
	{
		title: "Request Logs",
		url: `/${params.orgSlug}/${params.projSlug}/request-logs`,
		icon: Global,
	},
	{
		title: "Metrics",
		url: `/${params.orgSlug}/${params.projSlug}/metrics`,
		icon: TestTubesIcon,
	},
	{
		title: "Traces",
