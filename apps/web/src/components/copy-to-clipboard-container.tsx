...
>(({ children, className, align = "top", side = "right", sideOffset = 8, inset = "inside", ...props }, ref) => {
  ...
  return (
    <div className="relative group text-left">
      ...
      <Button
        ...
        style={{
          left: side === "left" ? (inset === "inside" ? sideOffset : -sideOffset) : undefined,
          right: side === "right" ? (inset === "inside" ? sideOffset : -sideOffset) : undefined,
        }}
      >
        {!isCopied ? (
