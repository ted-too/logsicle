...
export function EventCard({ event, style, className }: EventCardProps) {
                ...
                {event.channel && (
                  <Badge
                    ...
                    style={
                      event.channel.color
                        ? {
                            backgroundColor: `color-mix(in oklab, ${event.channel.color} 30%, transparent)`,
                            color: `color-mix(in oklab, ${event.channel.color} 80%, black)`,
                          }
                        : {}
                    }
                  >
