		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					className={cn(
						"group/sidebar-wrapper flex min-h-svh has-data-[variant=inset]:bg-sidebar transition-[width] duration-200 ease-linear",
						className,
					)}
					{...props}
				>
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				"flex h-10 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
