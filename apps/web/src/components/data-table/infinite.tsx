...
import { DataTableFilterCommand } from "@/components/data-table/filters/command";
import type {
  DataTableFilterField,
  SheetField,
} from "@/components/data-table/types";
import { DataTableToolbar } from "@/components/data-table/toolbar"; // TODO: check where to put this
...
import { TimelineChart } from "../logs-table/timeline-chart";
...
import { LiveButton } from "../logs-table/live-button";
import { RefreshButton } from "../logs-table/refresh-button";
import {
  appLogFilterSchema,
...
import { SelectInterval } from "../logs-table/select-interval";
...
export interface DataTableInfiniteProps<
  TType extends keyof TableTypeToData,
  TValue,
  TMeta,
> {
  type: TType;
  columns: ColumnDef<TableTypeToData[TType], TValue>[];
  getRowClassName?: (row: Row<TableTypeToData[TType]>) => string;
  // REMINDER: make sure to pass the correct id to access the rows
  getRowId: TableOptions<TableTypeToData[TType]>["getRowId"];
  data: TableTypeToData[TType][];
  defaultColumnFilters?: ColumnFiltersState;
  defaultColumnSorting?: SortingState;
  defaultRowSelection?: RowSelectionState;
  defaultColumnVisibility?: VisibilityState;
  filterFields?: DataTableFilterField<TableTypeToData[TType]>[];
  sheetFields?: SheetField<TableTypeToData[TType], TMeta>[];
  // REMINDER: close to the same signature as the `getFacetedUniqueValues` of the `useReactTable`
  getFacetedUniqueValues?: (
    table: TTable<TableTypeToData[TType]>,
    columnId: string
  ) => Map<string, number>;
  ...
  return (
    ...
    >
      ...
      <DataTableSheetDetails
        ...
        title={
          type === "app"
            ? (selectedRow?.original as AppLog | undefined)?.message
            : (selectedRow?.original as RequestLog | undefined)?.path
        }
